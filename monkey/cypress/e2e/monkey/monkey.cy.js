...
describe( `${appName} under smarter monkeys`, function() {
    ...
    cy.on('uncaught:exception', (err)=>{
        ...
        cy.screenshot('smart/'+screenshotIndex+"-"+ getEvtType(typeIndex)+"-exception");
    });
    ...
    cy.on('fail', (err)=>{
        ...
        cy.screenshot('smart/'+screenshotIndex+"-"+ getEvtType(typeIndex)+"-fail");
        return false;
    });
    it(`visits ${appName} and survives smarter monkeys`, function() {
        ...
        if(pcg === 100){
            ...
            cy.get('input[name="identification"]').type('hmaury1@gmail.com')
            cy.wait(500)
